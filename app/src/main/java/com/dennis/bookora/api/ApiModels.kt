...
fun UserApiResponse.toUser(): User = User(
    ...
    rating = rating ?: 0.0,
    booksPosted = booksPosted ?: 0,
    booksShared = booksShared ?: 0,
    favoritesCount = favoritesCount ?: 0,
    bio = bio ?: "",
    shareContactByEmail = shareContactByEmail ?: true
)
...
fun BookApiResponse.toBook(): Book = Book(
    ...
    author = author ?: "",
    category = category ?: "",
    condition = runCatching { com.dennis.bookora.models.ListingCondition.valueOf(condition ?: "GOOD") }.getOrDefault(com.dennis.bookora.models.ListingCondition.GOOD),
    location = location ?: "",
    postedDate = postedDate ?: "",
    postedTimestamp = postedTimestamp ?: 0L,
    coverUrl = coverUrl ?: "",
    listingType = runCatching { com.dennis.bookora.models.ListingType.valueOf(listingType ?: "GIVEAWAY") }.getOrDefault(com.dennis.bookora.models.ListingType.GIVEAWAY),
    ...
    coverColor = coverColor ?: 0xFFF0F4FF
)
