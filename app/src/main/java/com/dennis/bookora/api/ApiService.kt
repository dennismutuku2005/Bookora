...
interface ApiService {
    @POST("auth.php")
    suspend fun login(@Query("action") action: String = "login", @Body body: Map<String, String>): Response<ApiEnvelope<UserApiResponse>>

    @POST("auth.php")
    suspend fun register(@Query("action") action: String = "register", @Body body: Map<String, String>): Response<ApiEnvelope<UserApiResponse>>

    @GET("profile.php")
    suspend fun getProfile(@Query("action") action: String = "get", @Query("user_id") userId: String): Response<ApiEnvelope<UserApiResponse>>

    @POST("profile.php")
    suspend fun updateProfile(@Query("action") action: String = "update", @Body body: Map<String, Any>): Response<ApiEnvelope<UserApiResponse>>
    ...
    @POST("books.php")
    suspend fun createBook(@Body body: Map<String, Any>): Response<ApiEnvelope<BookApiResponse>>

    @PUT("books.php")
    suspend fun updateBook(@Query("id") id: String, @Body body: Map<String, Any>): Response<ApiEnvelope<BookApiResponse>>
    ...
    @POST("favorites.php")
    suspend fun addFavorite(@Query("action") action: String = "add", @Body body: Map<String, String>): Response<ApiEnvelope<Any>>

    @POST("favorites.php")
    suspend fun removeFavorite(@Query("action") action: String = "remove", @Body body: Map<String, String>): Response<ApiEnvelope<Any>>
    ...
    @POST("chat.php")
    suspend fun createConversation(@Query("action") action: String = "create", @Body body: Map<String, String>): Response<ApiEnvelope<ConversationApiResponse>>
    ...
    @POST("chat.php")
    suspend fun sendMessage(@Query("action") action: String = "send", @Body body: Map<String, String>): Response<ApiEnvelope<MessageApiResponse>>
    ...
    @POST("claims.php")
    suspend fun createClaim(@Query("action") action: String = "create", @Body body: Map<String, Any>): Response<ApiEnvelope<ClaimApiResponse>>

    @POST("claims.php")
    suspend fun confirmBookReceived(@Query("action") action: String = "confirm_received", @Body body: Map<String, String>): Response<ApiEnvelope<ClaimApiResponse>>

    @POST("claims.php")
    suspend fun confirmBookShared(@Query("action") action: String = "confirm_shared", @Body body: Map<String, String>): Response<ApiEnvelope<ClaimApiResponse>>

    @POST("claims.php")
    suspend fun acceptClaim(@Query("action") action: String = "accept", @Body body: Map<String, String>): Response<ApiEnvelope<ClaimApiResponse>>
